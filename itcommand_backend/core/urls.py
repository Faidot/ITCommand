...
from .views import (
    ...
    BillViewSet,
    FinanceDashboardView, SettingsView, ListOfValuesView, ListOfValuesItemView, IntegrationsView, IntegrationTestView, ActiveUsersView, AuditLogViewSet, LocationViewSet,
